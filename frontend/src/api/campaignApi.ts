...
export type RecommendedFund = {
  ...
  industry_allocation_source: string;
  fund_size: string;
  inception_date: string;
  management_fee: string;
  custody_fee: string;
  sales_service_fee: string;
  official_risk_level: string;
  ...
  risk_warning: string;
  field_sources: Record<string, "raw" | "calculated" | "inferred" | "generated" | "missing" | "mapped_from_holding_weight" | "holding_count_fallback" | string>;
  is_eligible: boolean;
